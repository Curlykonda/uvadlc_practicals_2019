...
python3 train.py --txt_file='./assets/alice_in_wonderland.txt' --book_name='alice' --train_steps=100000 --sample_every=1000 --snippet_completion=True --snippet='Alice began to'
