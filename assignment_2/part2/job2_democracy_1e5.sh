#!/bin/bash
#SBATCH --job-name=lstm_generator_democracy
#SBATCH --ntasks=1
...
python3 train.py --txt_file='./assets/book_EN_democracy_in_the_US.txt' --book_name='democracy' --train_steps=100000 --sample_every=1000
#python3 train.py --batch_size=128

cp -r "$TMPDIR"/work_lgpu0211 /home/lgpu0211/DL/uvadlc_practicals_2019/assignment_2/part2
